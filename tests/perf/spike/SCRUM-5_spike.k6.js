// storyKey: SCRUM-5
// testType: spike
// generated: 2026-04-22T10:15:11.984Z
...
export const options = {
  ...
  thresholds: {
    ...
    'login_duration':    ['p(50)<2100', 'p(90)<2700', 'p(95)<3000'],
    // Per-step latency budgets — navigate
    'navigate_duration': ['p(50)<2400', 'p(90)<3240', 'p(95)<3600'],
    // Per-step latency budgets — action
    'action_duration':   ['p(50)<3600', 'p(90)<5400', 'p(95)<6000'],
    // Dropped iterations
...
export default function (data) {
  ...
  /* no think time — spike must hit cold */;
}
...
export function handleSummary(data) {
  return {
    'test-results/perf/SCRUM-5_spike-summary.json': JSON.stringify(data, null, 2),
    'test-results/perf/SCRUM-5_spike-timeseries.csv': buildCsv(data),
